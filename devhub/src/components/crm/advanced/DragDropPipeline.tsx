      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        {pipelineData.map((stage) => (
          ...
          >
            ...
            {/* Add Lead Button */}
            <button className="w-full mt-3 p-2 border-2 border-dashed border-gray-300 rounded-lg text-gray-400 hover:border-gray-400 hover:text-gray-600 text-sm transition-colors">
              + Add Lead
            </button>
          </div>
        ))}
